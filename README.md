...
- À l’arrêt du script (`Ctrl+C` ou fin normale), le conteneur MindsDB lancé est supprimé automatiquement (`${CONTAINER_RUNTIME} rm -f ${MINDSDB_CONTAINER_NAME}`) pour éviter qu’il reste en arrière-plan.
