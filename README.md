...
- Déroulé:
  ...
  - Les données injectées aux agents Analyste et Rédaction sont désormais limitées à `EVIDENCE_LIMIT_DEFAULT` lignes par bloc pour éviter les dépassements de contexte côté LLM.
