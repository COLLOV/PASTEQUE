...
- Le backend tronque dynamiquement le dataset renvoyé au LLM pour rester sous ~60 Ko de JSON utile; si une ligne seule dépasse ce budget, l’API renvoie un 502 explicite invitant à filtrer ou agréger davantage avant de demander un graphique MCP.
