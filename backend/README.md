...
### Notes de maintenance
 ...
 - 2025-11-10: NL→SQL — sanitation de `NULLIF()` à deux arguments. Correction d'une régression où certains prompts pouvaient produire `NULLIF(col, 'None', 'None')` (3 arguments) et faire échouer l'analyse SQL (comparaison août vs juillet). Un fix pré‑parse convertit désormais toute forme avec >2 arguments en `NULLIF(arg1, arg2)` et s'applique aux phases explore/generate. Aucun effet de bord attendu.
