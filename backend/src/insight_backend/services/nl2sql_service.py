    ...
    def write(
        ...
        *,
        ...
        system = (
            ...
            "Après ces paragraphes, ajoute un court paragraphe additionnel (1 à 2 phrases) commençant par « De la donnée à l'action : » qui souligne les éléments les plus pertinents issus de ce bloc. "
